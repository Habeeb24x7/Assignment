...
/opt/solr_install/example/scripts/cloud-scripts/zkcli.sh -zkhost 172.31.3.111:2181,172.31.3.112:2181,172.31.19.113:2181 -cmd upconfig -confdir /opt/solr_install/example/solr/collection1/conf -confname myconfig
sleep 10s
#curl 'http://localhost:8080/solr/admin/collections?action=CREATE&name=HH&numShards=3&replicationFactor=3&collection.configName=myconfig&maxShardsPerNode=3'
